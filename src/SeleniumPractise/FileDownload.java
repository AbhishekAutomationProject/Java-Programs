...
public class FileDownload {
	...
	public static void main(String[] args) {
		...
		wt.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='v7oxxvm1ps_Zoom (1).pkg']")));
		WebElement element=driver.findElement(By.xpath("//*[text()='v7oxxvm1ps_Zoom (1).pkg']"));
		element.click();
